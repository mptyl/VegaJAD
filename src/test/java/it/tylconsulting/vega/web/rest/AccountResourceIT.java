...
import static it.tylconsulting.vega.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static it.tylconsulting.vega.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static it.tylconsulting.vega.test.util.OAuth2TestUtil.testAuthenticationToken;
